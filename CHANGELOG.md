...
- add `DuckDB::Value.create_map(map_type, keys, values)` to create MAP values from a MAP `DuckDB::LogicalType` and parallel Arrays of `DuckDB::Value` keys and values.
